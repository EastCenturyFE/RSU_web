...
import { devMode, restData, productInfo, pages } from '@/config'
...
Axios.defaults.headers.common['ProductInfo-Name'] = productInfo.name
Axios.defaults.headers.common['ProductInfo-Version'] = productInfo.version
