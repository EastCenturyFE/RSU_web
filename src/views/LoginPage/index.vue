<template>
  <div id="login">
      <div class="header">
        <img src="/static/img/login/log.png" alt="">
      </div>
      <div class="section">
        <div class="loginBox">
          <h3>日志监测系统</h3>
          <el-input
            ...
            clearable
            @keyup.enter.native="loginClickHandler"
          ></el-input>
          <el-input
            v-model="password"
            class="password"
            type="password"
            placeholder="请输入密码"
            prefix-icon="iconfont iconmima54"
            clearable
            @keyup.enter.native="loginClickHandler"
          ></el-input>
          <el-button
...
export default {
  ...
  mounted () {
    ...
    //   this.getDicData({ loginLoading: false })
    // }, 15000)
  ...
  .section {
    ...
    .loginBox {
      ...
      .login {
        ...
        margin-top: 35px;
        background: #4C92B1;
        // background: linear-gradient(to bottom right, #ffa05b, #ff6e1f);
        color: #fff;
        font-size: 18px;
        border: none;
        &:hover {
          // background: linear-gradient(to bottom right, #ffb45b, #ff821f);
          background: #5AA2C4;
        }
      }
    }
